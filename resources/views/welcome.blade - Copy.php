...
<body>
    <div class="main">
        <div class="container">
            <form id="signup-form" action="{{ route('register') }}" class="signup-form " role="form" method="post"
                ...
                <div>
                    ...
                    <fieldset>
                        <div class="fieldset-content">
                            <div class="tab">
                                <h2>Erectile Dysfunction intake</h2>
                            ...
                            @foreach ($data as $k => $val)
                                <div class="tab">{{ $val->title }}
                                    ...
                                    <input type="hidden" name="intake_data[{{$k}}][type]"          value="{{$val->type}}">
                                    <input type="hidden" name="intake_data[{{$k}}][title]"         value="{{$val->title}}">
                                    <input type="hidden" name="intake_data[{{$k}}][description]"   value="{{$val->description}}">
                                    <input type="hidden" name="intake_data[{{$k}}][label]"         value="{{$val->label}}">
                                    <input type="hidden" name="intake_data[{{$k}}][placeholder]"   value="{{$val->placeholder}}">
                                    <input type="hidden" name="intake_data[{{$k}}][is_important]"  value="{{$val->is_important}}">
                                    <input type="hidden" name="intake_data[{{$k}}][is_critical]"   value="{{$val->is_critical}}">
                                    <input type="hidden" name="intake_data[{{$k}}][is_optional]"   value="{{$val->is_optional}}">
                                    <input type="hidden" name="intake_data[{{$k}}][is_visible]"    value="{{$val->is_visible}}">
                                    <input type="hidden" name="intake_data[{{$k}}][order]"         value="{{$val->order}}">
                                    <input type="hidden" name="intake_data[{{$k}}][default_value]" value="{{$val->default_value}}">
                                    ...
                                    <input type="hidden" name="multiple_option[partner_questionnaire_question_id]" value="{{$val->partner_questionnaire_question_id}}">
                                    <input type="hidden" name="multiple_option[quest_type]" value="type_multiple_option">
                    ...
                    <h3 style="pointer:none !important">Select medication</h3>
                    <fieldset>
                        <div class="fieldset-content">
                            <div class="tab1"><h2>Which medication do you prefer?</h2>
                                <p class="desc">Specific drugs with dosages.</p>
                                @foreach($all_medicine as $k=>$medicine)
                                <div style="border: 1px solid; margin: 5px;">
                                    <div class="form-check p-2" style="display:flex; ">
                                        <input class="form-check-input" type="hidden" name="medication_data[dosespot_rxcui]" id="" value="{{$medicine->dosespot_rxcui}}" >
                                        <input class="form-check-input" type="hidden" name="medication_data[active]" id="" value="{{$medicine->active}}" >
                                        <input class="form-check-input" type="hidden" name="medication_data[ndc]" id="" value="{{$medicine->ndc}}" >
                                        <input class="form-check-input" type="hidden" name="medication_data[days_supply]" id="" value="{{$medicine->days_supply}}" >
                                        <input class="form-check-input" type="hidden" name="medication_data[refills]" id="" value="{{$medicine->refills}}" >
                                        <input class="form-check-input" type="hidden" name="medication_data[pharmacy_notes]" id="" value="{{$medicine->pharmacy_notes}}" >
                                        <input class="form-check-input" type="hidden" name="medication_data[directions]" id="" value="{{$medicine->directions}}" >
                                        <input class="form-check-input" type="hidden" name="medication_data[quantity]" id="" value="{{$medicine->quantity}}" >
                                        <input class="form-check-input" type="hidden" name="medication_data[dispense_unit]" id="" value="{{$medicine->dispense_unit}}" >
                                        <input class="form-check-input" type="hidden" name="medication_data[strength]" id="" value="{{$medicine->strength}}" >
                                        <input class="form-check-input" type="hidden" name="medication_data[dispense_unit_id]" id="" value="{{$medicine->dispense_unit_id}}" >
                                        <input class="form-check-input" type="hidden" name="medication_data[pharmacy_id]" id="" value="{{$medicine->pharmacy_id}}" >
                                        <input class="form-check-input" type="hidden" name="medication_data[pharmacy_name]" id="" value="{{$medicine->pharmacy_name}}" >
                                        <input class="form-check-input" type="hidden" name="medication_data[metadata]" id="" value="{{$medicine->metadata}}" >
                                        <input class="form-check-input" type="hidden" name="medication_data[thank_you_note]" id="" value="{{$medicine->thank_you_note}}" >
                                        <input class="form-check-input" type="hidden" name="medication_data[clinical_note]" id="" value="{{$medicine->clinical_note}}" >
                                        <input class="form-check-input" type="hidden" name="medication_data[allow_substitutions]" id="" value="{{$medicine->allow_substitutions}}" >
                                        <input class="form-check-input" type="hidden" name="medication_data[title]" id="" value="{{$medicine->title}}" >
                                        <input class="form-check-input" type="hidden" name="medication_data[partner_medication_id]" id="" value="{{$medicine->partner_medication_id}}" >
                                        <input class="form-check-input" type="hidden" name="medication_data[effective_date]" id="" value="{{$medicine->effective_date}}" >
                                        <input class="form-check-input" type="radio" name="medication_data[name]" id="exampleRadios1" value="{{$medicine->name}}" style="width:3% !important" >
                                        <label class="form-check-label" for="exampleRadios1" style="padding: 18px">{{$medicine->name}} | {{$medicine->strength}} </label>
                                    ...
                                    <div style="margin-left: 58px;"><p>Refills : {{$medicine->refills}} & Days_supply : {{$medicine->days_supply}}</p></div>
                                </div>
                                @endforeach
                            </div>
                            ...
                            <div class="tab1"><b>How often do you want to your meds shipped?</b>
                                ...
                                <div class="form-check p-2" style="display:flex;">
                                    <input class="form-check-input" type="radio" name="medication_data[shipped_time]" id="exampleRadios1" value="1" style="width:3% !important" >
                                    <label class="form-check-label" for="exampleRadios1" style="padding: 18px">
                                        Ship Every 1 Month
                                    </label>
                                </div>
                                <div class="form-check p-2" style="display:flex;">
                                    <input class="form-check-input" type="radio" name="medication_data[shipped_time]" id="exampleRadios2" style="width:3% !important" value="3">
                            ...
                            <div style="overflow:auto; padding:2px;" id="divBtn1">
                                <button type="button" id="nextBtn" onclick="nextPrev1(1)" style="width: 100%;">Continue</button>
                            </div>
                            <div style="text-align:center;margin-top:40px; display:none;">
